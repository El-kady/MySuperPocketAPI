        ...
        <div class="ui grid">
            ...
            <div class="twelve wide column">
                ...
                <div class="ui fluid vertical segment">
                    ...
                    <?php echo $this->form()->open("page", $this->route(["action" => "save", "params" => [$this->get("id", 0)]]), ["class" => "ui large form"]); ?>
                    ...
                    <div class="field">
                        <div class="field">
                            <label><?php echo $this->text("SLUG"); ?></label>
                            <div class="ui small left labeled icon input">
                                <input type="text" placeholder="<?php echo $this->text("SLUG"); ?>" id="title"
                                       name="slug" value="<?php echo $this->form()->valueOf("slug"); ?>"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="field">
                        ...
                        <textarea id="content" rows="2" name="content"
